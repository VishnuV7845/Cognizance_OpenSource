...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\vishn\Envs\calorieapp'
    let bin = 'Scripts'
    let path-sep = ';'
    ...
    let virtual-prompt = if ('calorieapp' == '') {
...
alias deactivate = source 'C:\Users\vishn\Envs\calorieapp\Scripts\deactivate.nu'
