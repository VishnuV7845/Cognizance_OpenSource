...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\vishn\Envs\calcwebapp'
    let bin = 'Scripts'
    let path-sep = ';'
    ...
    let virtual-prompt = if ('calcwebapp' == '') {
...
alias deactivate = source 'C:\Users\vishn\Envs\calcwebapp\Scripts\deactivate.nu'
